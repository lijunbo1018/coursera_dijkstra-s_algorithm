...
int main(int argc, char *argv[])
{
	...
	cout << "Average shortest cost is of spare graph: "<< spare_sum / spare_Graph.get_vertices() << endl;
	cout << "##############################################################" << endl;
	...
	cout << "Average shortest cost is of dense graph: "<< dense_sum / spare_Graph.get_vertices() << endl;
	return 0;
}
